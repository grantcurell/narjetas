...
To add support for a new language's conjugations create a new file with the schema: `<ISO 639-1 code>ProviderContainer.js`. Ex: `enConjugation.js` for English.
